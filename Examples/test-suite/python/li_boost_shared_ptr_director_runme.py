...
assert call_take_c_shared_ptr_by_value(a)       == 6
assert call_take_c_shared_ptr_by_ref(a)         == 7
assert call_take_c_shared_ptr_by_pointer(a)     == 8
assert call_take_c_shared_ptr_by_pointer_ref(a) == 9

assert call_take_c_shared_ptr_by_value_with_null(a)       == -2
assert call_take_c_shared_ptr_by_ref_with_null(a)         == -3
assert call_take_c_shared_ptr_by_pointer_with_null(a)     == -4
assert call_take_c_shared_ptr_by_pointer_ref_with_null(a) == -5
